...
| Oracle\_VM\_VirtualBox\_Extension\_Pack-7.1.10.vbox-extpack | VirtualBox拓展包               | Windows\_virtualbox       |
...
![安装Virtual Box](../images/vbox-install1.png "安装virtual Box")

![安装Virtual Box](../images/vbox-install2.png "安装virtual Box")

![安装Virtual Box](../images/vbox-install3.png "安装virtual Box")

!!! note 
    VirtualBox 最早由 Sun Microsystems 公司开发并以 GPL 协议开源。在 Oracle 收购 Sun 后，VirtualBox 主体部分仍以 GPL 协议开源的，但一些增强功能以采用 PUEL 协议的 Extention Pack 的方式提供。该[协议](https://www.virtualbox.org/wiki/Licensing_FAQ)规定，可以出于个人和教育目的免费使用 Extention Pack。商业用途需付费购买许可。
...
![导入虚拟机](../images/vbox-import2.png)
![导入虚拟机](../images/vbox-import3.png)
...
![minicom界面](../images/minicom3.png)
![minicom界面](../images/minicom4.png)
